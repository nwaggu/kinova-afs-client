...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/sharer/official_kortex_prime/src/ros_kortex/third_party/gazebo-pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/sharer/official_kortex_prime/devel/.private/gazebo_grasp_plugin)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /home/sharer/official_kortex_prime/install)
...
if(NOT "/home/sharer/official_kortex_prime/src/ros_kortex/third_party/gazebo-pkgs/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/sharer/official_kortex_prime/src/ros_kortex/third_party/gazebo-pkgs/gazebo_grasp_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sharer/official_kortex_prime/src/ros_kortex/third_party/gazebo-pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sharer/official_kortex_prime/devel/.private/gazebo_grasp_plugin/lib;/home/sharer/official_kortex_prime/devel/lib;/home/sharer/rob514_ws/devel/lib;/opt/ros/noetic/lib)
